        ...
        <div className="bg-calendar-submit-section bg-cover bg-center min-h-96 w-full flex flex-col items-center">
            ...
            >
                <Image
                    ...
                    width={384}
                    height={512}
                    className="md:w-24 md:h-24 md:w-48 md:h-auto mx-auto rounded-full md:rounded-none md:rounded-l-3xl"
                />
                <div className="flex flex-col bg-gray-900 bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-3xl md:rounded-none md:rounded-r-3xl">
                    <div className='pl-5 flex justify-between bg-gray-900 bg-opacity-10 backdrop-filter backdrop-blur-lg rounded-t-3xl md:rounded-none md:rounded-r-3xl'>
