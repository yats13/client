...
const ContactSection: React.FC = () => {
  return (
    <section id="contacts" className="mb-20">
      ...
      <div className="container mx-auto py-20 px-40 rounded-full border-b border-gray-300 flex flex-col md:flex-row items-start md:items-center justify-around space-y-4 md:space-y-0">
        ...
        <div className="text-gray-700 space-y-4">
          ...
          <div>
            <p className="font-semibold text-purple">Telegram:</p>
            <p className='text-mint'>@mirados.rescues</p>
            <div className="my-5">
