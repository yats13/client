...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var psychologists, _i, psychologists_1, psychData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // First clear existing data
                    _a.sent();
                    return [4 /*yield*/, prisma.psychologist.deleteMany()];
                case 2:
                    _a.sent();
                ...
                case 3:
                    ...
                    _i = 0, psychologists_1 = psychologists;
                    _a.label = 4;
                case 4:
                    if (!(_i < psychologists_1.length)) return [3 /*break*/, 7];
                    psychData = psychologists_1[_i];
                    return [4 /*yield*/, prisma.psychologist.create({
                            data: psychData,
                        })];
                case 5:
                    _a.sent();
